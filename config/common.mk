...
bootanimation_sizes := $(subst .zip,, $(shell ls vendor/serein/prebuilt/common/bootanimation))
...
PRODUCT_COPY_FILES += \
    vendor/serein/prebuilt/common/bootanimation/halfres/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
else
PRODUCT_COPY_FILES += \
    vendor/serein/prebuilt/common/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
endif
endif
