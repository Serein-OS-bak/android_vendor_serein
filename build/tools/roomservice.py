...
custom_local_manifest = ".repo/local_manifests/serein.xml"
custom_default_revision = "8.1"
custom_dependencies = "serein.dependencies"
org_manifest = "Serein-Devices"  # leave empty if org is provided in manifest
org_display = "Serein-Devices"  # needed for displaying
